...
class Primitive(object):
    ...
    returns the Python code to call the primitive with the arguments.
        ...
        'mul(1, 2)'
    """
    __slots__ = ('name', 'arity', 'args', 'ret', 'seq','info')

    def __init__(self, name, args, ret, info=None):
        self.name = name
        self.arity = len(args)
        self.args = args
        self.ret = ret
...
class Terminal(object):
    ...
    """
    __slots__ = ('name', 'value', 'ret', 'conv_fct','info')

    def __init__(self, terminal, symbolic, ret, info=None):
        self.ret = ret
        self.value = terminal
...
class PrimitiveSetTyped(object):
    ...
    def addPrimitive(self, primitive, in_types, ret_type,info=None, name=None):
        ...
        prim = Primitive(name, in_types, ret_type, info)
    ...
    def addTerminal(self, terminal, ret_type,info=None, name=None):
        ...
        prim = Terminal(terminal, symbolic, ret_type, info)
        self.info=info
        self._add(prim)
        self.terms_count += 1
...
class PrimitiveSet(PrimitiveSetTyped):
    ...
    def addPrimitive(self, primitive, arity,info=None, name=None):
        ...
        args = [__type__] * arity
        PrimitiveSetTyped.addPrimitive(self, primitive, args, __type__,info, name)

    def addTerminal(self, terminal,info=None, name=None):
        """Add a terminal to the set."""
        PrimitiveSetTyped.addTerminal(self, terminal, __type__,info, name)
